...
add_bullet_list(slide, Inches(0.7), Inches(1.5), Inches(11.5), Inches(5.0), [
    ...
    "Scans for PAM sites across 5 nucleases, evaluates 7 base editors",
...
cols = [
    ("Multi-Nuclease\nEngine", "5 nucleases x 7 editors\n= 35 combinations\nrescued BE: 0/30 -> 6/30",
     TEAL, Inches(0.7)),
...
add_title_bar(slide, "Multi-Nuclease Feasibility Engine",
              "Systematic evaluation of 5 nucleases x 7 base editors")
...
add_textbox(slide, Inches(0.7), Inches(5.3), Inches(11.5), Inches(0.4),
            "Base Editor Profiles (7 editors)", font_size=16, color=TEAL, bold=True)
add_multiline(slide, Inches(0.7), Inches(5.8), Inches(5.5), Inches(1.0), [
    ("ABE7.10: window 4-7 (Tier A)", WHITE, False),
    ("ABE8e: window 3-9 extended (Tier A)", TEAL, True),
    ("BE4max: window 4-8 (Tier A)", WHITE, False),
], font_size=13, line_spacing=1.3)
add_multiline(slide, Inches(6.5), Inches(5.8), Inches(5.5), Inches(1.0), [
    ("ABE8e + enFnCas9: NRG + broad window (Tier B)", CORAL, False),
    ("ABE8e + SpCas9-NG: NG PAM access (Tier B)", WHITE, False),
    ("BE4max + enFnCas9: NRG + CBE (Tier B)", WHITE, False),
], font_size=13, line_spacing=1.3)
...
# ---- SLIDE 10: ABE8e Rescue Mechanism --------------------------------------
slide = prs.slides.add_slide(blank_layout)
set_slide_bg(slide)
...
# ---- SLIDE 11: KEY FINDING - BE Rescue -------------------------------------
slide = prs.slides.add_slide(blank_layout)
set_slide_bg(slide, RGBColor(0x15, 0x1E, 0x2B))
